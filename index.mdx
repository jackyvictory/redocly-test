...
<Jumbotron>
  ...
  <H1>EVO Cloud</H1>
  <H2>An integrated acquiring host and payment gateway</H2>
...
<Box my={25}>
  <SectionHeader>
    Start your <Emphasis> payment integration </Emphasis> today!
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1} header="Before you begin">
    ...
    <ThinTile to="developer-portal/index.md" icon={launchFastIcon} header="Start integrating">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </ThinTile>
    <ThinTile to="contact.mdx" icon={icon3} header="Test and go live">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </ThinTile>
